...
public class ObjectDocumentationConfig {
    ...
    static {
        put(DOCUMENTATION, ObjectType.AS_BLOCK, "" +
        ...
        put(DOCUMENTATION, ObjectType.AS_SET, "" +
        ...
        put(DOCUMENTATION, ObjectType.AUT_NUM, "" +
        ...
        put(DOCUMENTATION, ObjectType.IRT, "" +
                "      An irt object is used to define a Computer Security Incident\n" +
                "      Response Team (CSIRT).\n");

        put(DOCUMENTATION, ObjectType.KEY_CERT, "" +
        ...
        put(DOCUMENTATION, ObjectType.ORGANISATION, "" +
        ...
        put(DOCUMENTATION, ObjectType.PEERING_SET, "" +
        ...
        put(DOCUMENTATION, ObjectType.PERSON, "" +
        ...
        put(DOCUMENTATION, ObjectType.ROUTE, "" +
        ...
        put(DOCUMENTATION, ObjectType.ROUTE6, "" +
                "      Each interAS route (also referred to as an interdomain route)\n" +
        ...
        put(DOCUMENTATION, ObjectType.ROUTE_SET, "" +
        ...
        put(DOCUMENTATION, ObjectType.RTR_SET, "" +
