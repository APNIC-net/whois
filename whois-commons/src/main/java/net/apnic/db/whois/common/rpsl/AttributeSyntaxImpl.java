...
//                "header from the key body.\n"));
            ...
            put(attributeSyntaxTypeMap, AttributeSyntaxType.PUBLIC_KEY_SYNTAX, new AnySyntax("" +
            ...
            put(attributeSyntaxTypeMap, AttributeSyntaxType.DOM_NET_SYNTAX, new AttributeSyntaxRegexp(254,
            ...
            put(attributeSyntaxTypeMap, AttributeSyntaxType.FINGERPR_SYNTAX, new AttributeSyntaxRegexp(
...
//                "| <protocol> <peering-set-name> <options>\n"));
            ...
            put(attributeSyntaxTypeMap, AttributeSyntaxType.PERSON_NAME_SYNTAX, new AttributeSyntaxRegexp(80,
...
//                "                default number, 43, is used."));
            ...
            put(attributeSyntaxTypeMap, AttributeSyntaxType.REFERRAL_BY_SYNTAX,  new AttributeSyntaxRegexp(
                    Pattern.compile("(?i)^APNIC-DBM-MNT$"), "" +
                    "Only APNIC-DBM-MNT is allowed.\n"));

            put(attributeSyntaxTypeMap, AttributeSyntaxType.REGISTRY_NAME_SYNTAX,  new AttributeSyntaxRegexp(
...
//
            ...
            // The following statement has been changed and not working.  Found that need to change RIPE inetnumStatus module to suit APNIC
            put(attributeSyntaxTypeMap, AttributeSyntaxType.SUBDOMAIN_NAME_SYNTAX, new AttributeSyntaxRegexp(
