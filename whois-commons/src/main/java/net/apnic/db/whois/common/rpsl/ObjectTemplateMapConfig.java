    ...
    static {
        final ArrayList<ObjectTemplate> objectTemplates = Lists.newArrayList(
                ...
                new ObjectTemplate(ObjectType.AUT_NUM, 8,
                        ...
                        new AttributeTemplate(DESCR, MANDATORY, MULTIPLE),
                        new AttributeTemplate(COUNTRY, MANDATORY, SINGLE),
                        ...
                        new AttributeTemplate(MNT_BY, MANDATORY, MULTIPLE, INVERSE_KEY),
                        new AttributeTemplate(MNT_IRT, MANDATORY, MULTIPLE, INVERSE_KEY),
                        new AttributeTemplate(CHANGED, MANDATORY, MULTIPLE),
                        new AttributeTemplate(SOURCE, MANDATORY, SINGLE)),
                ...
                new ObjectTemplate(ObjectType.DOMAIN, 30,
                        ...
                        new AttributeTemplate(MNT_LOWER, OPTIONAL, MULTIPLE, INVERSE_KEY),
// TODO:
//      APNIC might be removing this obsolete attribute so I've left it commented for now
//      and the attribute template/syntax definitions are still in place.
//      So if definitely removing, then remove the attribute template/syntax as well
//      If definitely keeping, then create an index strategy (IndexStrategies) so the server won't crash on update
//                        new AttributeTemplate(APNIC_REFER, OPTIONAL, SINGLE),
                        new AttributeTemplate(CHANGED, MANDATORY, MULTIPLE),
                        new AttributeTemplate(SOURCE, MANDATORY, SINGLE)),
                ...
                new ObjectTemplate(ObjectType.IRT, 41,
                        ...
                        new AttributeTemplate(ABUSE_MAILBOX, MANDATORY, MULTIPLE, INVERSE_KEY),
                ...
                new ObjectTemplate(ObjectType.MNTNER, 40,
                        ...
                        new AttributeTemplate(MNT_BY, MANDATORY, MULTIPLE, INVERSE_KEY),
                        new AttributeTemplate(REFERRAL_BY, MANDATORY, SINGLE, INVERSE_KEY),
                        new AttributeTemplate(CHANGED, MANDATORY, MULTIPLE),
                        new AttributeTemplate(SOURCE, MANDATORY, SINGLE)),
