...
public class StatusValidatorTest {
    ...
    public void setup() {
        ...
        when(maintainers.getEnduserMaintainers()).thenReturn(ciSet("APNIC-HM-MNT"));
    ...
    public void invalid_child_status_fails_ipv4() {
        ...
        verify(updateContext).addMessage(update, UpdateMessages.incorrectChildStatus("ALLOCATED PORTABLE", "ALLOCATED NON-PORTABLE"));
    }
...
//    }
    ...
    public void parent_has_assigned_pa_status_and_grandparent_is_allocated_pa_and_has_rs_maintainer() {
        ...
        verify(updateContext).addMessage(update, UpdateMessages.incorrectParentStatus(ObjectType.INETNUM, "ASSIGNED PORTABLE"));
    }
    ...
    public void incorrect_parent_status_ipv4() {
        ...
        verify(updateContext).addMessage(update, UpdateMessages.incorrectParentStatus(ObjectType.INETNUM, "ALLOCATED NON-PORTABLE"));
    }
    ...
    public void correct_parent_status_ipv4() {
        ...
        when(maintainers.getRsMaintainers()).thenReturn(CIString.ciSet("APNIC-HM-MNT"));
        when(update.getUpdatedObject()).thenReturn(RpslObject.parse("inetnum: 192.0/24\nstatus: ASSIGNED PORTABLE\nmnt-by: APNIC-HM-MNT"));
